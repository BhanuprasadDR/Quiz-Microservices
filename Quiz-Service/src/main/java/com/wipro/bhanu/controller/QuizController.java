...
import com.wipro.bhanu.service.QuizService;
...
public class QuizController {
    ...
    public Quiz createQuizFallBackMethod(String category,String level,String title,Throwable throwable) {
    	
    	Quiz fallbackQuiz=new Quiz();
    	fallbackQuiz.setTitle("Our question service is down please try again after some time");
		return fallbackQuiz;
    	
    }
    
    @GetMapping("/getQuizById/{id}")
    public List<com.wipro.bhanu.entities.QuestionWrapper> getQuizById(@PathVariable Integer id){
